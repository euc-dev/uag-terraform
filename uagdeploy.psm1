#
# Copyright (c) 2015-2024 Omnissa, LLC.
# -- Omnissa Public
#
...
function GetOidcConfiguration {
	...
	while ($invalidOidcClientSecret) {
		...
		$oidcClientSecret = Read-Host -assecurestring $prompt

		if ($oidcClientSecret.length -gt 0) {
			$oidcClientSecret = ConvertFromSecureToPlain $oidcClientSecret
